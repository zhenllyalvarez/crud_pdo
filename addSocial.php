...
<body>
    <div class="min-h-screen flex items-center justify-center flex-col">
        <div class="w-3/4 sm:w-1/2 relative overflow-x-auto shadow-md sm:rounded-lg">
            <form class="p-12" action="createSocial.php" method="post">
                <h1 class="text-center text-7xl font-semibold uppercase mb-8">Add social</h1>
                <a href="alldata.php"><button class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-8 mb-5 rounded mx-auto flex">Back</button></a>
                <div class="mb-6">
